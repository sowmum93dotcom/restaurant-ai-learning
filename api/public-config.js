...
async function publicConfig(req, res) {
  ...
  if (req?.query?.resource === "customer-intentions" ||
    ...
    const action = req.method === 'POST' ? DEMEOS_ACTIONS.RECORD_OWN_CUSTOMER_INTENTION : DEMEOS_ACTIONS.VIEW_OWN_CUSTOMER_INTENTIONS;
