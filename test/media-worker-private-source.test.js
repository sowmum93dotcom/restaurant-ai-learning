...
test("worker delegates an exact short-lived private source before processing",async()=>{
 ...
 const repository={recoverStaleMediaProcessingJobs:async()=>[],reconcileUnqueuedProcessingMedia:async()=>[],reconcileMediaProcessingQueue:async()=>[],claimNextMediaProcessingJob:async()=>({job_id:1,asset_id:"a1",business_id:"b1",attempts:1}),getBusinessMediaAsset:async()=>asset,saveBusinessMediaAsset:async(b,a)=>a,finishMediaProcessingJob:async()=>{}};
