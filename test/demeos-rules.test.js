...
test("supported scopes and actions are immutable constants", function () {
  ...
  assert.deepEqual(Object.values(DEMEOS_ACTIONS), [
    ...
    "remove-own-customer-intention",
    "record-own-customer-saved-possibility",
    "view-own-customer-saved-possibilities",
    "remove-own-customer-saved-possibility",
    "view-own-customer-participation",
    "record-own-customer-preference",
    "view-own-customer-preferences",
    "view-own-customer-feedback",
    "view-own-customer-privacy-controls",
    "manage-own-customer-privacy-controls",
    "remove-own-customer-preference",
